...
perturbatively and therefore they are accounted as $\mathcal{O}(\alpha_s)$ (this is true in the case in which intrinsic components
...
(\url{https://github.com/NNPDF/eko}), a code written in \texttt{Python} that solves the DGLAP equation with the
...
The second step of the project has been the extension of the NNPDF fitting code (\url{https://github.com/NNPDF/nnpdf}) to consider also
a photon PDF.
...
Even though I spent the most of my Ph.D.\ on the PDFs fits, I have also great interests in more theoretical topics of QCD,
