...
Since they enter in the computation of every hadronic observable, their extraction from experimental data has to be performed 
with a high accuracy.
With this aim in mind, the methodogical and computational techniques used in their determination are of fundamental importance.
Another crucial aspect, is the theoretical description of deep-inelastic-scattering (DIS) data, that provide a very strong constraint
on the PDF.

My research covered both these aspects:
on one side I worked in the NNPDF collaboration both on the theory side and as a developer of the NNPDF code to provide computational
tools that are able to determine PDFs at the percent precision;
on the other side I worked on a new scheme that can increase the theoretical understanding of DIS predictions, and therefore of the PDFs
determination.
